...
const u32 cim_verb_data[] = {
	...
	AZALIA_PIN_CFG(0, 0x11, 0x40130000),
	AZALIA_PIN_CFG(0, 0x12, 0x411111f0),
	AZALIA_PIN_CFG(0, 0x14, 0x01014010),
	AZALIA_PIN_CFG(0, 0x15, 0x01011012),
	AZALIA_PIN_CFG(0, 0x16, 0x01011611),
	AZALIA_PIN_CFG(0, 0x17, 0x01011214),
	...
	AZALIA_PIN_CFG(0, 0x1d, 0x4025d601),
	AZALIA_PIN_CFG(0, 0x1e, 0x01441130),
	AZALIA_PIN_CFG(0, 0x1f, 0x4025d601),
};
